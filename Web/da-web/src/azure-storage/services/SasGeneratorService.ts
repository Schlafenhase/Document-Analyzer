...
export class SasGeneratorService {
  getSasToken(): Observable<BlobStorageRequest> {
    ...
    const res$ = of (
        {"storageUri":"https://schlafenhase.blob.core.windows.net/","storageAccessToken":"sv=2020-02-10&ss=bfqt&srt=sco&sp=rwdlacupx&se=2021-04-13T04:59:42Z&st=2021-04-12T20:59:42Z&spr=https&sig=l5e92%2Fu1ITvM0DdayjFEbZSxhHumDU3FcER070ZUXm8%3D"}
        );
    // const res$ = of (
